---
title: Overview
description: Motion is Motionly's readable source format for canvas, elements, tracks, clips, audio, and animations.
---
...
`import` accepts SVG, PNG, JPEG, MP4, and WebM. Video assets decode natively and use the same timeline `clip` syntax as images.
